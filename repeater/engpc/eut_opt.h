...
#define ENG_WIFIEFUSEINFO_REQ ("EFUSEINFO?")
...
#define ENG_WIFICALTXPWR ("CALTXPWR")
#define ENG_WIFICALTXPWREFUSEEN ("CALTXPWREFUSEEN")
#define ENG_WIFITPCMODE ("TPCMODE")
#define ENG_WIFITSSI ("TSSI")
